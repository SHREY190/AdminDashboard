...
const Insights = () => {
  return (
    <motion.div
      className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl col-span-2 p-6 border border-gray-700 mb-8"
      ...
      <div className="space-y-2">
        {INSIGHTS.map((item, index) => (
          <div key={index} className="flex items-start space-x-3">
            ...
            <p className="text-gray-300 self-center">{item.insight}</p>
          </div>
        ))}
      </div>
    </motion.div>
